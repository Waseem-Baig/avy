  ...
  return (
    <div className="flex flex-col mb-1">
      ...
      <input
        type={type}
        id={id}
        className={`${width} px-[2px] py-[5px] border-t-[3px] border-l-[3px] border-b-[1px] border-r-[1px] rounded-md shadow-[inset_-5px_-5px_13px_0px_#FFFFFF,_inset_3px_3px_13px_0px_#DFD6D199] placeholder:text-[#9E9E9E] placeholder:text-[12px] text-black`}
    ...
    <div className="absolute inset-0 flex items-start justify-center p-4 mt-[40vh]">
      <div className="bg-[#FDFEFF] shadow-lg rounded-lg py-4 px-4 w-[95%] max-w-md h-auto">
        ...
        <form className="flex flex-col gap-1 px-[5vw]">
          ...
          <div className="mb-1">
            ...
            <input
              ...
              id="confirm-password"
              className="w-full px-[2px] py-[5px] border-t-[3px] border-l-[3px] border-b-[2px] border-r-[2px] rounded-lg shadow-[inset_-5px_-5px_13px_0px_#FFFFFF,_inset_3px_3px_13px_0px_#DFD6D199] placeholder:text-[#9E9E9E] placeholder:text-[12px] text-black"
        ...
        <div className="flex gap-1 justify-center items-center">
          ...
          <button className="text-blue-700 text-[1rem]" onClick={handleSignIn}>
            Log In
          </button>
        </div>
      </div>
