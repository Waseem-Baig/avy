  ...
  return (
    <div className="flex justify-center pl-[5vw] pr-[5vw] mb-[5vh]">
      <div className="bg-[#EEF5FC] relative w-[90vw] h-auto shadow-[10px_10px_30px_0px_rgba(174,174,192,0.4),_-10px_-10px_30px_0px_#FFFFFF] rounded-xl flex flex-col py-4 px-4 font-dm-sans">
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-lg">Prohibited Uses</h2>
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-lg">Compliance with Laws</h2>
          <p className="px-4">
            <strong></strong>
          </p>
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-lg">User Responsibility</h2>
          <ul className="list-disc list-inside px-4 space-y-1">
            <li>
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-lg">Reporting Misuse</h2>
          <ul className="list-disc list-inside px-4 space-y-1">
            <li>
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-lg">Enforcement and Monitoring</h2>
          <ul className="list-disc list-inside px-4 space-y-1">
            <li>
        ...
        <section className="space-y-2 text-[#002E5B] mb-6 text-[12px]">
          <h2 className="font-semibold text-xl">Acknowledgment</h2>
          <p className="px-4">
